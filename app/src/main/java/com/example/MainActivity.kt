    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MyApplicationTheme {
                ...
                Scaffold(modifier = Modifier.fillMaxSize(), containerColor = DarkCanvas,
                    ...
                    Box(modifier = Modifier.fillMaxSize().padding(innerPadding).background(DarkCanvas)) {
                        when (currentDestination) {
                            ...
                            NavDestination.PROFILE -> ProfileSettingsScreen(
                                ...
                                isSeedanceConfigured = isSeedanceConfigured,
                                ...
                                onSaveGeminiApiKey = { key -> viewModel.saveGeminiApiKey(key); isAiConfigured = true },
                                onClearGeminiApiKey = { viewModel.clearGeminiApiKey(); isAiConfigured = false },
                                onSaveSeedanceApiKey = { key -> viewModel.saveSeedanceApiKey(key); isSeedanceConfigured = true },
                                onClearSeedanceApiKey = { viewModel.clearSeedanceApiKey(); isSeedanceConfigured = false },
                                onSelectVideoProvider = { provider -> viewModel.saveVideoProvider(provider); selectedVideoProvider = provider },
